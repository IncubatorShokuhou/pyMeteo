...
顶层是英文蛇形名。NCL 内建名在 [`pymeteo.ncl`](NCL_zh.md)，**不会**再导出到包根。
...
| 页面 | 模块 | 内容 |
|------|------|------|
| [安装](Install_zh.md) | — | `pip install pymeteo-kit`，Python 3.6+，开发 |
| [单位](Units_zh.md) | `pymeteo.units` | 别名、内部量纲、`UnitError` |
| [热力学](Thermo_zh.md) | `pymeteo.thermo` | 水汽、θ、θe、LCL、湿球、能见度 |
| [指数](Indices_zh.md) | `pymeteo.indices` | 沙氏、K、A、TT、SWEAT、LI |
| [风](Wind_zh.md) | `pymeteo.wind` | 风速、风向、分量、体风切变 |
| [几何与气压](Geo_zh.md) | `pymeteo.geo` | 距离、重力、海平面气压、厚度 |
| [体感](Comfort_zh.md) | `pymeteo.comfort` | NWS 热指数、风寒 |
| [动力学](Dynamics_zh.md) | `pymeteo.dynamics` | 科里奥利、ω ↔ w |
| [NCL 兼容](NCL_zh.md) | `pymeteo.ncl` | 固定单位的名字封装 |
| [发布与贡献](Publishing_zh.md) | — | PyPI 发布、测试、贡献 |
